...
Welcome to my personal projects repository — a collection of things I've built while learning, exploring, and solving problems I find interesting. This serves as a portfolio of my work outside of professional projects.

## 🧰 Tech Skills

`SQL` · `Python` · `SSRS` · `Snowflake` · `AWS`
